				...
				<div class="page-content">
					<div class="page-bar">
						<?php if(isset($_REQUEST['add_s'])){?>
							<p style="color:green;font-size:20px ;">Frenchies form Posted Successfully ......</p><?php } ?>
						<?php if(isset($_REQUEST['add_ns'])){?>
							<p style="color:red;font-size:20px ;">Please check your file type and file size.</p><?php } ?>
						<div class="page-title-breadcrumb">
							<div class=" pull-left">
								<div class="page-title">Add Frenchies form</div>
							</div>
					...
					<div class="row">
						<div class="col-sm-12">
							<div class="card-box">
								<div class="card-head">
									<header>Frenchies form  Details</header>
								...
								<div class="card-body row">
									...
									<div class="col-lg-12 p-t-20">
										<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
											<input class="mdl-textfield__input" type="text" id="txttitle" name="notice_hlt" required>
											<label class="mdl-textfield__label" >Frenchies form Title*</label>
										</div>
									</div>
