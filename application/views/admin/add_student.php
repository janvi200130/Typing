						...
						<div class="col-sm-12">
							<div class="card-box">
								...
								<div class="card-body row">
									...
									<div class="col-lg-12 p-t-20">
										<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
											<input class="mdl-textfield__input" type="text" id="txttitle" name="class" required>
											<label class="mdl-textfield__label">Student Class</label>
										</div>
									</div>
										<div class="col-lg-12 p-t-20">
