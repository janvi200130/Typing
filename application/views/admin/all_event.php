								...
								<div class="card-body ">
									<table class="table table-striped table-bordered table-hover table-checkable order-column valign-middle" id="example4 table-responcive" >
										...
										<tbody>
											...
											<tr class="odd gradeX">
												<td><?php echo $sn++;?></td>
												<td style="width: 4cm;"><?=$key->notice_day?>/<?=$key->notice_month?>/<?=$key->notice_year?></td>
												<td style="width: 2cm;"><?=$key->notice_hlt?></td>
												<td style="width: 2cm;"><a href="<?=base_url();?>assets/upload_img/notice_file/<?=$key->notice_file?>">view</a></td>
												<!-- <td class="left"><?=$key->event_date?></td> -->
												
												<!-- <td><?=$key->event_details?></td> -->
												<td>
													
													<a  class="" href="<?=base_url('ED');?>?q=<?=$key->notice_id;?>" id="dlt" type="button">
