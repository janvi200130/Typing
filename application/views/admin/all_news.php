									...
									<table class="table table-striped  table-bordered table-hover table-checkable order-column valign-middle" id="example4">
										...
										<tbody>
											...
											<tr class="odd gradeX">
												...
												<td class="left"><img src="<?=base_url();?>assets/upload_img/news_file/<?=$key->news_file?>" height="50" width="50"></td>
												<!-- <td class="left"><?=$key->event_date?></td> -->
												<td ><?=$key->news_hlt?></td>
												<td><?=$key->news_dtls?></td>
												<td>
													<!-- <a href="<?=base_url('Update_News');?>?q=<?=$key->news_id;?>" class="tblEditBtn">
														<i class="fa fa-pencil"></i>
													</a> -->
													<a  class="" href="<?=base_url('ND');?>?q=<?=$key->news_id;?>" id="dlt" type="button">
