					...
					<div class="page-bar">
						<div class="page-title-breadcrumb">
							...
							<!-- <ol class="breadcrumb page-breadcrumb pull-right">
								...
								<li><a class="parent-item" href="">Gallery</a>&nbsp;<i class="fa fa-angle-right"></i>
								</li>
									...
									<table class="table table-striped table-bordered table-hover table-checkable order-column valign-middle" id="example4">
										...
										<tbody>
											...
											<tr class="odd gradeX">
												<td><?php echo $sn++;?></td>
												<td><?=$key->caption?></td>
												<td style="width: 6cm;"><?=$key->video?></td>
												<td><?=$key->date?></td>
												<td><a href="delete_video?id=<?=$key->id;?>"><i class="fa fa-trash" aria-hidden="true"></i></a></td>
											</tr>
											<?php }?>
										</tbody>
									</table>
