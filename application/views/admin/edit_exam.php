				...
				<div class="page-content">
					<div class="page-bar">
						...
						<div class="page-title-breadcrumb">
							<div class=" pull-left">
								<div class="page-title">Edit Exam Pattern</div>
							</div>
										...
										?>
											<div class="col-lg-6 p-t-20">
												<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
													<input class="mdl-textfield__input" type="text" id="txttitle" name="ex_name" value="<?= $row->exam_name ?>" required>
													<label class="mdl-textfield__label">Exam Name*</label>
												</div>
											</div>
											<div class="col-lg-6 p-t-20">
												<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
													<input class="mdl-textfield__input" type="text" id="txttitle" name="duration" required value="<?= $row->duration ?>">
													<label class="mdl-textfield__label">Exam Duration*</label>
													<select name="duration_type" id="" required>
											...
											<div class="col-lg-6 p-t-20">
												<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
													<input class="mdl-textfield__input" type="text" id="txttitle" name="mark" required value="<?= $row->total_mark ?>">
													<label class="mdl-textfield__label">Total Marks*</label>
												</div>
											</div>
											<div class="col-lg-6 p-t-20">
												<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
													<input class="mdl-textfield__input" type="text" id="txttitle" name="question" required value="<?= $row->total_question ?>">
													<label class="mdl-textfield__label">Number Of Question*</label>
												</div>
											</div>

											<div class="col-lg-6 p-t-20">
												<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
													<input class="mdl-textfield__input" type="text" id="txttitle" name="max_ques" required value="<?= $row->avg_question_mark ?>">
													<label class="mdl-textfield__label">Maximum questions Mark*</label>
												</div>
											</div>

											<div class="col-lg-12 p-t-20 text-center">
												<button type="submit" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect m-b-10 m-r-20 btn-circle btn-primary">Update</button>
