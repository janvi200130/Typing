				...
				<div class="page-content">
					<div class="page-bar">
						<div class="page-title-breadcrumb">
							<div class=" pull-left">
								<div class="page-title">Student Registration Details</div>
							</div>
                        </div>
					</div>
					...
					<div class="row">
  						...
  						<div class="col-sm-8">
    						<div class="card">
      							<div class="card-body">
       								<center> <h1 class="card-title">Select Exam</h1>
  						...
  						<div class="col-sm-8">
    						<div class="card">
								  ...
								  <div class="form-check">
									<input class="form-check-input" type="checkbox" value="<?php $value->email ?>" id="flexCheckDefault"><?= $value->email ?></div>
								  <?php } ?>
								</div>
							</div>
						</div>
					...
					<div class="row">
  						<div class="col-sm-8">
    						<div class="card">
      							<div class="card-body">
									<a href=""><center><button class="btn btn-info">Submit</button></center></a>
            					</div>
            				</div>
            			</div>
            		</div>
