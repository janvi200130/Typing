                    ...
                    <li class="mdl-menu__item"><i class="material-icons">favorite</i>Something else
                      here</li>
								...
								<?php if (isset($_REQUEST['updated'])) { ?>
										<center>
											<p style="color:green;font-size:20px ;"> Successfully Updated Exam ......</p>
									...
									<?php if (isset($_REQUEST['changed'])) { ?>
										<center>
											<p style="color:green;font-size:20px ;"> Successfully changed status ......</p>
									...
									<?php if (isset($_REQUEST['success'])) { ?>
										<center>
											<p style="color:green;font-size:20px ;"> Successfully deleted ......</p>
										...
										<tbody>
											...
											foreach ($show as $key) { ?>
												<tr class="odd gradeX">
													...
													<td class="left"><?= $key->duration; ?></td>
													<td class="left"><?= $key->total_question; ?></td>
													<td class="left"><?= $key->total_mark; ?></td>
													<td class="left"><?= $key->status; ?></td>
													<td>
														<a class="" href="<?= base_url('change_status'); ?>?q=<?= $key->exam_id; ?>" id="dlt" type="button">
															Change Status
														</a>
                            ...
                            <i class="fa fa-pencil"></i>
														...
														<a class="" href="<?= base_url('delete_exam'); ?>?q=<?= $key->exam_id; ?>" id="dlt" type="button">
															<i class="fa fa-trash-o"></i>
														</a>

														<a class="btn btn-success" href="<?= base_url('question_list'); ?>?q=<?= $key->exam_id; ?>" id="dlt" type="button">
															<i class="fa fa-eye"></i>
														</a>

														<a class="btn btn-info" href="<?= base_url('exam_edit'); ?>?q=<?= $key->exam_id; ?>" id="dlt" type="button">
