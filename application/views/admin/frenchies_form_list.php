				...
				<div class="page-content">
					<div class="page-bar">
						<div class="page-title-breadcrumb">
							<div class=" pull-left">
								<div class="page-title">Frenchies Form List</div>
							</div>
							<ol class="breadcrumb page-breadcrumb pull-right">
								<li><i class="fa fa-home"></i>&nbsp;<a class="parent-item" href="">Home</a>&nbsp;<i class="fa fa-angle-right"></i>
								</li>
								<li><a class="parent-item" href="">Frenchies Form</a>&nbsp;<i class="fa fa-angle-right"></i>
								</li>
								<li class="active">Frenchies Form List</li>
							</ol>
						</div>
					</div>
					<div class="row">
						<div class="col-md-12 col-sm-12">
							<div class="card-box card-responcive" >
								<div class="card-head">
									<header>Frenchies Form List</header>
										...
										<tbody>
											...
											<tr class="odd gradeX">
												...
												<td>
													...
													<a   class="btn btn-danger" href="<?=base_url('delete_frenchies');?>?q=<?=$key->id;?>" id="dlt" type="button">
