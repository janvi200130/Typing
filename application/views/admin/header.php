				...
				<div class="top-menu">
					<ul class="nav navbar-nav pull-right">
								...
								<li>
									<ul class="dropdown-menu-list small-slimscroll-style" data-handle-color="#637283">
										<li>
											<a href="#">
												<span class="photo">
													<img src="<?=base_url();?>admin_assets/img/user/user2.jpg" class="img-circle" alt="">
												</span>
												<span class="subject">
										...
										<li>
											<a href="#">
												<span class="photo">
													<img src="<?=base_url();?>admin_assets/img/user/user3.jpg" class="img-circle" alt="">
												</span>
												<span class="subject">
										...
										<li>
											<a href="#">
												<span class="photo">
													<img src="<?=base_url();?>admin_assets/img/user/user1.jpg" class="img-circle" alt="">
												</span>
												<span class="subject">
										...
										<li>
											<a href="#">
												<span class="photo">
													<img src="<?=base_url();?>admin_assets/img/user/user8.jpg" class="img-circle" alt="">
												</span>
												<span class="subject">
										...
										<li>
											<a href="#">
												<span class="photo">
													<img src="<?=base_url();?>admin_assets/img/user/user5.jpg" class="img-circle" alt="">
												</span>
												<span class="subject">
						...
						<li class="dropdown dropdown-user">
							<a class="dropdown-toggle" data-bs-toggle="dropdown" data-hover="dropdown" data-close-others="true">
								<img alt="" class="img-circle " src="<?=base_url();?>admin_assets/img/dp.jpg">
					...
					<div id="remove-scroll" class="left-sidemenu">
						<ul class="sidemenu  page-header-fixed slimscroll-style" data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200" style="padding-top: 20px">
							...
							<li class="sidebar-user-panel">
								<div class="sidebar-user">
									<div class="sidebar-user-picture">
										<img alt="image" src="<?=base_url();?>admin_assets/img/gd_logo.png" style="border-color: none;">
									</div>
							...
							<!-- <li class="nav-item">
								...
								<ul class="sub-menu">
									<li class="nav-item">
										<a href="<?=base_url("ED");?>" class="nav-link "> <span class="title">All
												Events</span>
										</a>
									</li>
									<li class="nav-item">
										<a href="<?=base_url("AdminController/event_add")?>" class="nav-link "> <span class="title">Add
												Event</span>
										</a>
									</li>
							</li> -->
							...
							<li class="nav-item">
								...
								<ul class="sub-menu">
									<li class="nav-item">
										<a href="all_<?=base_url();?>admin_assets.html" class="nav-link "> <span class="title">All Library
												<?=base_url();?>admin_assets</span>
										</a>
									</li>
									<li class="nav-item">
