										...
										<tbody>
											...
											foreach ($show as $key) { ?>
												<tr class="odd gradeX">
													<td><?php echo $sn++; ?></td>
													<td><?= $key->question ?></td>
													<td class="left"><?= $key->option_a; ?></td>
													<td class="left"><?= $key->option_b; ?></td>
													<td class="left"><?= $key->option_c; ?></td>
													<td class="left"><?= $key->option_d; ?></td>
													<td class="left"><?= $key->answer; ?></td>

													<td>
														<!--  <a href="" class="tblEditBtn">
                            <i class="fa fa-pencil"></i>
                          </a> -->
														<a class="" href="<?= base_url('delete_question'); ?>?q=<?= $key->ques_refrence; ?>" id="dlt" type="button">
