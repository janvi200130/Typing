								...
								<div class="card-body ">
									<table class="table table-striped table-bordered table-hover table-checkable order-column valign-middle" id="example4 table-responcive" >
										...
										<tbody>
											...
											<tr class="odd gradeX">
												<td><?php echo $sn++;?></td>
												<td style="width: 4cm;"><?=$key->name;?></td>
												<td style="width: 2cm;"><?=$key->designation?></td>
												<td style="width: 2cm;"><img src="<?=base_url();?><?=$key->file_location;?>" width="100"></td>
												<!-- <td class="left"><?=$key->event_date?></td> -->
												
												<!-- <td><?=$key->event_details?></td> -->
												<td>
													
													<a   class="btn btn-danger" href="<?=base_url('delete_staff');?>?q=<?=$key->id;?>" id="dlt" type="button">
